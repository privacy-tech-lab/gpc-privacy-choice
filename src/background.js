...
try {
  ...
  self.importScripts("firebase/firebase-app.js", "firebase/firebase-database.js", "firebase/firebase-firestore.js");
  ...
  chrome.runtime.onInstalled.addListener(async function (r) {
  ...
  // ======= moving firebase js into this =====
  // Add user entries into the Firebase
  function addHistory(referrer, site, GPC, applyALLBool, enabledBool, currentUserDocID, tabId, uiScheme){
      let date = new Date();
  ...
  function addSettingInteractionHistory(domain, originSite, currentUserDocID, setting, prevSetting, newSetting, universalSetting, location, subcollection){
      let date = new Date()
  ...
  console.log("errors in service worker: ", e);
}