...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  if (request.greeting == "INTERACTION") {
    chrome.storage.local.get( "USER_DOC_ID", function(result){
      addSettingInteractionHistory(request.domain, request.location, result.USER_DOC_ID, request.origin, request.setting, request.prevSetting, request.newSetting, request.universalSetting);
    })
  }
